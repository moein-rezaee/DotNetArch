...
- **Development Swagger setup**: API projects automatically reference `Microsoft.AspNetCore.OpenApi`, register Swagger services, and enable Swagger UI in development while removing default template files.
