...
- **Automatic migrations**: `new crud` and `new action` trigger EF Core migrations and database updates right after scaffolding when the `dotnet-ef` tool is available.
