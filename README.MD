...
```
dotnet-arch new action --entity=EntityName --action=download --is-command=true
```

The tool generates the command/query, handler, validator, repository method, and controller endpoint for the specified action.
