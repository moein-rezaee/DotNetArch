...
";
            File.WriteAllText(uowInterfaceFile, iContent.Replace("{{solution}}", solution).Replace("{{entity}}", entity));
        }
        else
        {
...
";
            File.WriteAllText(uowFile, uContent.Replace("{{solution}}", solution).Replace("{{entity}}", entity).Replace("{{lower}}", lower));
        }
        else
        {
